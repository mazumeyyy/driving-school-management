...
<body style="background: var(--bg);">
    ...
    <script>
        ...
        function loadCerts() {
            fetch('/php/certificate/read.php')
                ...
                .then(data => {
                    ...
                    if (!data.length) {
                        tbody.innerHTML = '<tr><td colspan="5" class="text-center py-4 text-muted">No certificates issued yet.</td></tr>';
                        return;
                    }
        ...
        function submitIssueCert() {
            ...
            fetch('/php/certificate/issue.php', {
                    method: 'POST',
                    body: formData
                })
                .then(r => r.json())
    ...
    `;
        ...
        function deleteCert(id) {
            ...
            fetch('/php/certificate/delete.php', {
                ...
                .then(r => r.json())
                .then(data => {
                    if (data.status === 'success') loadCerts();
                });
        }
    </script>
</body>
